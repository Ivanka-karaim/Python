...
def check(index):
    if (
            ...
            (expression[index - 1] not in Number and expression[index] == '0' and expression[index+1] in Number) or
...
if (
        (expression == "") or (expression[0] not in Number and expression[0] != '-') or
